package com.jeecg.ylbxpzgrxx.service.impl;
...
@Service("ylbxpzgrxxService")
@Transactional
public class YlbxpzgrxxServiceImpl extends CommonServiceImpl implements YlbxpzgrxxServiceI {

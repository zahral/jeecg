package com.jeecg.shiyedwjbxx.service.impl;
...
@Service("shiyedwjbxxService")
@Transactional
public class ShiyedwjbxxServiceImpl extends CommonServiceImpl implements ShiyedwjbxxServiceI {

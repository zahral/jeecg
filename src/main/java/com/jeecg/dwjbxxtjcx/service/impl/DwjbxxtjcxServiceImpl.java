package com.jeecg.dwjbxxtjcx.service.impl;
...
@Service("dwjbxxtjcxService")
@Transactional
public class DwjbxxtjcxServiceImpl extends CommonServiceImpl implements DwjbxxtjcxServiceI {

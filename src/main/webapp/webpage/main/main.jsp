...
<!--add-start--:wangkun Date:20160813 for:内部聊天修改-->
...
<div region="north" border="false" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
    <%--<div region="north" border="false" title=" Framework  <t:mutiLang langKey="system.version.number"/>" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">--%>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
    <td align="left" style="vertical-align: text-bottom;"><img src=""> <img src="plug-in/login/images/foot.png"></td>
        ...
        <table>
            <tr>
                <td valign="top" height="50">
                    ...
                    <span style="color: #666633">北京市社保局</span>
                    <%--${currentOrgName }--%>
...
<div collapsed="true" region="east" iconCls="icon-reload" title="<t:mutiLang langKey="common.assist.tools"/>" split="true" style="width: 190px;"
    ...
    <div class="easyui-layout" fit="true" border="false">
		...
		<div region="center" border="false" style="overflow: hidden;">
			<div  >
                <%--id="layout_jeecg_onlinePanel" fit="true" border="false" title='<t:mutiLang langKey="common.online.user"/>'--%>
				<table id="layout_jeecg_onlineDatagrid"></table>
			</div>
		</div>
...
</div>  <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;

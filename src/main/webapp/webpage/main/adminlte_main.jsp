...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              <li>
                ...
                <ul class="menu">
                  ...
                  <%--<li>--%>
                    <%--<a href="javascript:window.open('http://yun.jeecg.org')" title="源代码框架自带">--%>
                      <%--<i class="fa fa-warning text-yellow"></i>源代码自带--%>
                    <%--</a>--%>
                  <%--</li>--%>
                  <li>
                  ...
                  <li><a href="javascript:toSwagger()"><i class="fa fa-users text-red"></i> Swagger</a></li>
                  <li> 
  ...
  <%--<footer class="main-footer">--%>
    ...
    <%--<a href="http://www.jeecg.org" title="JEECG Framework  <t:mutiLang langKey="system.version.number"/>">Framework <t:mutiLang langKey="system.version.number"/></a>--%>

           <%--<a href="#" title="JEECG Framework  <t:mutiLang langKey="system.version.number"/>"> Framework  <t:mutiLang langKey="system.version.number"/></a>--%>
  <%--</footer>--%>

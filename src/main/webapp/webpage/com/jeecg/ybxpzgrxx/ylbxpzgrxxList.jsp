...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ylbxpzgrxxList" checkbox="false" pagination="true" fitColumns="true" title="医疗保险凭证个人基本信息" sortName="id" actionUrl="ylbxpzgrxxController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="单位编号"  field="dwbh"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="单位名称"  field="dwmc"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="个人编号"  field="grbh"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="身份证号"  field="gcsfzh"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="姓名"  field="xm"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="性别"  field="xb"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="邮政编码"  field="yzbm"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
